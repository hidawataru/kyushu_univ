...
try {
  ...
  $stmt = $pdo->prepare('select * from fkt_kiki."M_User" where mail_address1 = ?');
...
if ($_POST['password'] == $row['password']) {
  ...
  //実際のURLに変更する必要あり
  //:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  header('Location: http://kiki.prodevice.jp/index.php');
} else {
  //:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  //実際のURLに変更する必要あり
  //:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  header('Location: http://kiki.prodevice.jp/singup.php');
  return false;
}
