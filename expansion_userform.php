...
<?php 
        ...
        $results = $pdo->prepare(
            'UPDATE fkt_kiki."M_User" SET mail_address2 = :mail , phone_extension = :phone_extension WHERE mail_address1 = :mail_address1'
        );
        ...
        $results = $pdo->prepare(
            'SELECT * FROM fkt_kiki."M_User" WHERE mail_address1 = :mail_address1'
        );
        $results->bindValue(':mail_address1', $_SESSION['EMAIL'], PDO::PARAM_STR);
        $results->execute();
